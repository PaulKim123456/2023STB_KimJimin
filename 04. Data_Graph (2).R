#히스토그램
hist(finedust$`3_ultrafine dust`, main="서울시 서대문구 2020년 1월 초미세먼지측정분포", col= terrain.colors(12))

hist(finedust$`3_ultrafine dust`, main="서울시 서대문구 2020년 1월 초미세먼지측정분포", col= terrain.colors(12), freq = FALSE)
lines(density(finedust$`3_ultrafine dust`), lwd=2)

#박스 플롯
boxplot(finedust$`3_fine dust`, main="야식업의 2020년 1월 미세먼지 발생상황", col = "yellow")
boxplot(finedust$`3_fine dust`,finedust$`7_fine dust`, main="야식업의 2020년 1월 미세먼지 발생상황", col = "yellow", names = c("야식업","중식"))
